[![Java CI with Gradle](https://github.com/shvisor/Actions/actions/workflows/gradle.yml/badge.svg)](https://github.com/shvisor/Actions/actions/workflows/gradle.yml)
